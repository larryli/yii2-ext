...
return [
    ...
    '{attribute} is not a valid URL.' => '{attribute}不是一条有效的 URL。',
    ...
    '{attribute} must be a valid IP address.' => '{attribute}必须是一个有效的 IP 地址。',
    '{attribute} must be an IP address with specified subnet.' => '{attribute}必须指定一个 IP 地址和子网。',
    ...
    '{attribute} must not be an IPv4 address.' => '{attribute}必须不是一个 IPv4 地址。',
    '{attribute} must not be an IPv6 address.' => '{attribute}必须不是一个 IPv6 地址。',
